<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link  {{ Str::endsWith(request()->path(), '/dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}">
        ...
        <li class="nav-item">
            <a class="nav-link  {{ Str::endsWith(request()->path(), '/get-all-user') ? 'active' : '' }}" href="{{ route('allUsers') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link  {{ Str::endsWith(request()->path(), '/get-admin-details') ? 'active' : '' }}" href="{{ route('getAdminDetails') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
            <a class="nav-link  {{ Str::endsWith(request()->path(), '/setting') ? 'active' : '' }}" href="{{ route('adminSetting') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
