                      ...
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder mb-0">
                          ...
                          <div class="progress-wrapper">
                            ...
                            <div class="progress">
                              <div class="progress-bar bg-primary" role="progressbar" aria-namenow="20" aria-namemin="0" aria-namemax="100" style="width: 20%;"></div>
                            </div>
                          </div>
                          <a class="text-success text-sm font-weight-bolder" href="{{ route('user.profile') }}"> Let's Start</a>
                        </h5>
                      </div>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <select id="country" name="country" class="form-control">
                                            ...
                                            <option name="Holy See (Vatican City State)">Holy See (Vatican City State)</option>
                                            ...
                                            <option name="Korea, Democratic People's Republic of">Korea, Democratic People's Republic of</option>
                                            <option name="Korea, Republic of">Korea, Republic of</option>
                                            ...
                                            <option name="Macedonia, The Former Yugoslav Republic of">Macedonia, The Former Yugoslav Republic of</option>
                                            ...
                                            <option name="Moldova, Republic of">Moldova, Republic of</option>
                                            ...
                                            <option name="Palestinian Territory, Occupied">Palestinian Territory, Occupied</option>
                                            ...
                                            <option name="Tanzania, United Republic of">Tanzania, United Republic of</option>
